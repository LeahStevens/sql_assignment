...
class TestExportsImports < ExportsImportsTest
  def test_country_defaults_to_unknown
    exportsimports = ExportsImports.create(country: "China", year: "2014", month: "01", type: "e", amount: "23435")
  ...
  def test_to_s_prints_details
    ...
    expected = "China: 2014, 01, e, 23435, countryid: #{exportsimports.countrycountryid}"
...
def test_update_doesnt_insert_new_row
  ...
  def test_update_saves_to_the_database
    ...
    exportsimports.update(country: "India", year: "2014", month: "02", type: "e", amount: "23435")
    updated_exportsimports = ExportsImports.find(countryid)
    expected = ["India", 2014, 01, "e", 23435]
  ...
  def test_save_saves_country_countryid
    ...
    exportsimports = ExportsImports.create(country: "China", year: "2014", month: "01", type: "e", amount: "23435", country: country)
  ...
  def test_save_update_country_countryid
    ...
    exportsimports = ExportsImports.create(country: "China", year: "2014", month: "01", type: "e", amount: "23435", country: country1)
  ...
  def test_find_returns_nil_if_unfindable
    assert_nil ExportsImports.find(12342)
  end
  ...
  def test_search_returns_exportsimports_objects
    ExportsImports.create(country: "China", year: 2015, month: 01, type: "e", amount: 2342)
    ExportsImports.create(country: "India", year: 2015, month: 01, type: "e", amount: 2342)
    ExportsImports.create(country: "India", year: 2015, month: 01, type: "e", amount: 2342)
  ...
  def test_search_returns_appropriate_results
    ...
    exportsimports1 = ExportsImports.create(country: china, year: 2015, month: 01, type: "e", amount: 2342)
    exportsimports2 = ExportsImports.create(country: "India", year: 2015, month: 01, type: "e", amount: 2342)
    exportsimports3 = ExportsImports.create(country: "India", year: 2015, month: 01, type: "e", amount: 2342)
  ...
  def test_equality_on_same_object
    exportsimports = ExportsImports.create(country: "China", year: 2015, month: 01, type: "e", amount: 2342)
